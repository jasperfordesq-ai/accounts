...
- This slice promotes the four-step human evidence closeout path into the production
...
- The frontend parser now rejects reports whose closeout path omits, reorders or
  retargets the template, `scripts/verify-release-evidence.ps1`,
  `release-evidence-report.json` / `humanEvidenceCompletion`, or
