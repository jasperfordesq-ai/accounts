        ...
        var categories = new[]
        {
            ...
            Category(
                ...
                [
                    ...
                    "CI runs scripts/verify-ci-machine-evidence-pack.ps1 and retains ci-machine-evidence-pack-report.json with exact commit/run identity, SHA-256 inventory for dependency, safety, monitoring, structured log, backup/restore, no-direct, readiness and visual/workbench evidence, plus a prepared reviewer-workspace summary proving the 21-file workspace and six unassigned reviewer assignment rows with pickup-file guidance.",
