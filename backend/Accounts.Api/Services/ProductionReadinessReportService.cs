        ...
        var categories = new[]
        {
            ...
            Category(
                ...
                [
                    ...
                    "release-artifact-pack-report.json now records release candidate identity, per-report and reviewer-handoff SHA-256/byte-size evidence, plus a release-evidence workspace summary with the 21-file prepared workspace, six pending human blockers, six unassigned reviewer assignment rows and reviewerAssignmentPickupFileGuidanceCount for retained pickup files.",
                    "CI runs scripts/verify-ci-machine-evidence-pack.ps1 and retains ci-machine-evidence-pack-report.json with exact commit/run identity, SHA-256 inventory for dependency, safety, monitoring, structured log, backup/restore, no-direct, readiness and visual/workbench evidence, plus a prepared reviewer-workspace summary proving the 21-file workspace and six unassigned reviewer assignment rows with complete per-gate pickup-file guidance.",
