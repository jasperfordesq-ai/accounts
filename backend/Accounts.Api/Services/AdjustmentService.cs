...
{
    public record AdjustmentSummary(int AutoGenerated, int ManualCount, int PendingApproval, int Approved, decimal TotalImpactOnProfit, decimal TotalImpactOnAssets);
