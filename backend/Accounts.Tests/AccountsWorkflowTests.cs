...
public class AccountsWorkflowTests
{
    ...
    public void ReleaseArtifactPackVerifier_RequiresExactOperationalEvidenceReports()
    {
        ...
        Assert.Contains("routeAcceptance.$($expected.routeName).screenshotReviewEvidence must be $($expected.routeName)-light-dark-desktop-mobile-screenshot-review", script);
        Assert.Contains("routeAcceptance.$($expected.routeName).screenshotReviewEvidence must be $($expected.routeName)-light-dark-desktop-mobile-screenshot-review", machineEvidencePack);
        ...
        Assert.Contains("routeReadiness.$($expected.routeName).screenshotCount must be 4", script);
        Assert.Contains("routeReadiness.$($expected.routeName).screenshotCount must be 4", machineEvidencePack);
        Assert.Contains("routeReadiness.$($expected.routeName).layoutCheckResultCount must be 12", script);
        Assert.Contains("routeReadiness.$($expected.routeName).layoutCheckResultCount must be 12", machineEvidencePack);
        Assert.Contains("routeReadiness.$($expected.routeName).contrastCheckResultCount must be 4", script);
        Assert.Contains("routeReadiness.$($expected.routeName).contrastCheckResultCount must be 4", machineEvidencePack);
        ...
        Assert.Contains("visual-smoke-evidence-report.json layoutCheckResultCount must be 84", script);
        Assert.Contains("visual-smoke-evidence-report.json layoutCheckResultCount must be 84", machineEvidencePack);
        ...
        Assert.Contains("visual-smoke-evidence-report.json contrastCheckResultCount must be 28", script);
        Assert.Contains("visual-smoke-evidence-report.json contrastCheckResultCount must be 28", machineEvidencePack);
        ...
        Assert.Contains("visual-smoke-evidence-report.json routeCoverage must include exactly 7 route(s)", script);
        Assert.Contains("visual-smoke-evidence-report.json routeCoverage must include exactly 7 route(s)", machineEvidencePack);
        Assert.Contains("routeCoverage.$($expectedRoute.routeName).routeKey must be $($expectedRoute.routeKey)", script);
        Assert.Contains("routeCoverage.$($expectedRoute.routeName).routeKey must be $($expectedRoute.routeKey)", machineEvidencePack);
        Assert.Contains("routeCoverage.$($expectedRoute.routeName).screenshotCount must be 4", script);
        Assert.Contains("routeCoverage.$($expectedRoute.routeName).screenshotCount must be 4", machineEvidencePack);
        Assert.Contains("routeCoverage.$($expectedRoute.routeName).reviewStatus must be required-review", script);
        Assert.Contains("routeCoverage.$($expectedRoute.routeName).reviewStatus must be required-review", machineEvidencePack);
        Assert.Contains("routeCoverage.$($expectedRoute.routeName).requiredReviewChecks", script);
        Assert.Contains("routeCoverage.$($expectedRoute.routeName).requiredReviewChecks", machineEvidencePack);
        Assert.Contains("screenshots must include exactly 28 retained screenshots", script);
        Assert.Contains("screenshots must include exactly 28 retained screenshots", machineEvidencePack);
        ...
        Assert.Contains("visual-smoke-evidence-report.json screenshots must include $($expectedRoute.routeName)/$theme/$($expectedViewport.name)", script);
        Assert.Contains("visual-smoke-evidence-report.json screenshots must include $($expectedRoute.routeName)/$theme/$($expectedViewport.name)", machineEvidencePack);
        Assert.Contains("screenshots.$($expectedRoute.routeName).$theme.$($expectedViewport.name).routeKey must be $($expectedRoute.routeKey)", script);
        Assert.Contains("screenshots.$($expectedRoute.routeName).$theme.$($expectedViewport.name).routeKey must be $($expectedRoute.routeKey)", machineEvidencePack);
        Assert.Contains("screenshots.$($expectedRoute.routeName).$theme.$($expectedViewport.name).fileName must be $expectedFileName", script);
        Assert.Contains("screenshots.$($expectedRoute.routeName).$theme.$($expectedViewport.name).fileName must be $expectedFileName", machineEvidencePack);
        Assert.Contains("screenshots.$($expectedRoute.routeName).$theme.$($expectedViewport.name).expectedText must be $($expectedRoute.expectedText)", script);
        Assert.Contains("screenshots.$($expectedRoute.routeName).$theme.$($expectedViewport.name).expectedText must be $($expectedRoute.expectedText)", machineEvidencePack);
        Assert.Contains("screenshots.$($expectedRoute.routeName).$theme.$($expectedViewport.name).reviewStatus must be required-review", script);
        Assert.Contains("screenshots.$($expectedRoute.routeName).$theme.$($expectedViewport.name).reviewStatus must be required-review", machineEvidencePack);
