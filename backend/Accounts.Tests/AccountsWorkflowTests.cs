...
public class AccountsWorkflowTests
{
    ...
    public void ReleaseArtifactPackVerifier_RequiresExactOperationalEvidenceReports()
    {
        ...
        Assert.Contains("production-readiness\"; routeKey = \"readiness\"; expectedText = \"Production Readiness Checklist\"", script);
        Assert.Contains("financial-statements\"; routeKey = \"financialStatements\"; expectedText = \"Financial Statements\"", machineEvidencePack);
