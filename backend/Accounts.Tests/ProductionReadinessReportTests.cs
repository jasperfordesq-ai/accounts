...
public class ProductionReadinessReportTests
{
    ...
    public async Task ProductionReadinessReport_ExposesGoalScorecardMappedToReleaseBlockers()
    {
        ...
        Assert.Equal(651, report.ProductionScorecard.CurrentScore);
        ...
        Assert.Equal((230, 250), (scores["backend-statutory-accounting-engine"].CurrentScore, scores["backend-statutory-accounting-engine"].TargetScore));
        Assert.Equal((172, 200), (scores["frontend-accountant-workbench"].CurrentScore, scores["frontend-accountant-workbench"].TargetScore));
        ...
        Assert.Contains(scores["frontend-accountant-workbench"].CurrentEvidence, evidence =>
            evidence.Contains("pass/accepted", StringComparison.OrdinalIgnoreCase)
