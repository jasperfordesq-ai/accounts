...
public class ProductionReadinessReportTests
{
    ...
    public async Task ProductionReadinessReport_ExposesGoalScorecardMappedToReleaseBlockers()
    {
        ...
        Assert.Equal(613, report.ProductionScorecard.CurrentScore);
        ...
        Assert.Equal((203, 250), (scores["backend-statutory-accounting-engine"].CurrentScore, scores["backend-statutory-accounting-engine"].TargetScore));
