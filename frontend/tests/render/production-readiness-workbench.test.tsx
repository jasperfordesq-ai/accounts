    ...
    categories: [
      ...
      },
      {
        ...
        currentEvidence: [
          ...
          "release-artifact-pack-report.json records release candidate identity, per-report and reviewer-handoff SHA-256/byte-size evidence, plus a release-evidence workspace summary with the 21-file prepared workspace, six pending human blockers and six unassigned reviewer assignment rows with retained reviewer pickup files.",
          "ci-machine-evidence-pack-report.json records exact commit/run identity, machine-evidence SHA-256 inventory and a prepared reviewer-workspace summary with the 21-file workspace plus six unassigned reviewer assignment rows with pickup-file guidance.",
