    ...
    categories: [
      ...
      },
      {
        ...
        currentEvidence: [
          ...
          "verify-release-artifact-pack.ps1 independently parses release-evidence-workspace-verification-report.json, requires the same release candidate and exact 19-file prepared workspace inventory, and manifests retained reviewer handoff files with SHA-256/byte-size evidence.",
