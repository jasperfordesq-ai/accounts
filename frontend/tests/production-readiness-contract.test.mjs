    ...
    categories: [
      {
        ...
        currentEvidence: [
          ...
          "Release evidence reviewer workspace verification inventories and rejects prepared human templates with prefilled top-level reviewer/accountant identity, signature or acceptance checkbox fields.",
        ],
