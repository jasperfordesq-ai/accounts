...
const inputClass = "w-full rounded-lg border border-gray-300 bg-white px-3 py-2 text-sm text-gray-900 focus:border-emerald-500 focus:outline-none focus:ring-2 focus:ring-emerald-500/20 dark:border-neutral-700 dark:bg-neutral-950 dark:text-gray-100";
          ...
          <div className="grid gap-5 xl:grid-cols-[1.15fr_0.85fr]">
            <Card><Card.Header><div><Card.Title className="flex items-center gap-2"><UserPlus className="h-5 w-5" /> Provision a user</Card.Title><Card.Description>Invitation is preferred. Direct creation requires a strong temporary password and forces rotation.</Card.Description></div></Card.Header>
              <Card.Content><form className="grid gap-3 sm:grid-cols-2" onSubmit={provision}>
                ...
                <label className="flex items-center gap-2 self-end pb-2 text-sm"><input type="checkbox" checked={createMode} onChange={(event) => setCreateMode(event.target.checked)} /> Create directly with temporary password</label>
